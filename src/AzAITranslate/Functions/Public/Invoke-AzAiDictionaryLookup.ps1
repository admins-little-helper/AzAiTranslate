...
.GUID babe85ac-c612-4387-8c52-ddb26aa9f99c
...
function Invoke-AzAiDictionaryLookup {
    <#
    .SYNOPSIS
        Lookup up dictionary for a specified word.
    ...
    .LINK
        https://github.com/admins-little-helper/AzAiTranslate/blob/main/Help/Invoke-AzAiDictionaryLookup.md
    #>
    ...
    [CmdletBinding()]
    param(
        [Parameter(Mandatory = $true, HelpMessage = "The text to translate.")]
        [String[]]
        $InputString,
        ...
        [Parameter(Mandatory = $true, HelpMessage = "Specify the source language.")]
        [ArgumentCompleter({
                Param (
                    $Command,
                    $Parameter,
    ...
    begin {
        ...
        $Uri = "$($ServiceEndpointUri)/dictionary/lookup?api-version=$TextApiVersion"
